...
// FIX: Updated WarningIcon to accept all standard SVG props by using React.ComponentProps<'svg'>. This allows passing attributes like 'title' for tooltips, fixing the TypeScript error in PhaseCard.tsx.
